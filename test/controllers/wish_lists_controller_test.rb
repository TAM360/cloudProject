...
class WishListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wish_list" do
    assert_difference('WishList.count') do
      post wish_lists_url, params: { wish_list: { location_name: @wish_list.location_name, user_id: @wish_list.user_id } }
    end
  ...
  test "should update wish_list" do
    patch wish_list_url(@wish_list), params: { wish_list: { location_name: @wish_list.location_name, user_id: @wish_list.user_id } }
